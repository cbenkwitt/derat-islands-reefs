...
ggplot(aes(x=Region , y=N15, fill=Treatment, color = Treatment, shape = Treatment)) + 
 geom_boxplot(outlier.size=0, outlier.stroke=0, alpha=0.7) +
  ...
  theme_bw() + 
  scale_x_discrete(labels = c('Chagos \n Archipelago','Scattered \n Islands'))+
...
ggplot(aes(x=Region , y=N15, fill=Treatment, color = Treatment, shape = Treatment)) + 
 geom_boxplot(outlier.size=0, outlier.stroke=0, alpha=0.7) +
  geom_point(stat="identity", position = position_jitterdodge(dodge.width=.7), alpha = 0.7) + 
  scale_fill_manual(values = c("#33A02C", "#1F78B4", "#E31A1C" )) +  ###"#A50026", "#FEE090", "#4575B4"   ####"#33A02C", "#1F78B4", "#E31A1C"
   scale_colour_manual(values = c("#33A02C", "#1F78B4", "#E31A1C" )) +
...
N15_all_plots <-
  ggdraw() + 
  draw_plot(soil_box, x = 0, y = .66, width = .49, height = .33) +
  draw_plot(leaves_box, x = .5, y = .66, width = .49, height = .33) +
  draw_plot(macro_box, x = 0, y = .33, width = .49, height = .33) +
  draw_plot(turf_box, x = .5, y = .33, width = .49, height = .33) +  
  draw_plot(fish_box, x = 0, y = 0, width = .49, height = .33) +
  draw_plot(N15_post_plot3, x = 0.5, y = 0, width = .49, height = .33) 

#ggsave(filename = "N15_box_plots2_hpdi_aug19_E.pdf", 
#       plot = N15_all_plots,
#       width = 7.3,
#       height = 10,
#       units = "in",
...
###try seperate boxplots per region:
```{r}
...
##and combine with separate for each regin
```{r}
